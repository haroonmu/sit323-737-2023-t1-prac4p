...
const logger = winston.createLogger({
  ...
  // addition funtion  between two parameters
const add= (n1,n2) => {
    return n1+n2;
}
app.get("/add", (req,res)=>{
  ...
  // Subtraction function  between two parameters
  const sub= (n1,n2) => {
    return n1-n2;
}
app.get("/sub", (req,res)=>{
  ...
  // Multiplocation funtion  between two parameters
...
// Division funtion  between two parameters
const divide= (n1,n2) => {
  return n1/n2;
}
